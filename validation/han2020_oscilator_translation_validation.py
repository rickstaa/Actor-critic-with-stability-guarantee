...
This script assesses the translation fidelity of the 'Oscillator' environment from
...
from envs.oscillator import oscillator as Oscillator  # noqa: E402
...
if __name__ == "__main__":
    ...
    print(
        textwrap.dedent(
            ...
            script initializes the Oscillator environment and performs '{STEPS}' steps
    ...
    csv_file_path = os.path.join(
        SCRIPT_DIR, "results/oscillator_translation_validation.csv"
    )
